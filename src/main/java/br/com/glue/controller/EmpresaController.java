...
public class EmpresaController {
	...
	@GetMapping(value = "/{idTag}/{idNote}", produces = { MediaType.APPLICATION_JSON_VALUE })
	public ResponseEntity<EmpresaDTO> getById(@PathVariable int idTag,@PathVariable int idNote) {

		var object = this.repository.getById(idTag, idNote);
	...
	public ResponseEntity<EmpresaDTO> delete(@PathVariable int id) {
		...
		var optional = Optional.ofNullable(repository.getById(idTag, idNote));
